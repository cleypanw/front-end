...
resource "aws_security_group" "k8s-security-group" {
  ...
  tags = {
    yor_trace = "6bed302a-42a4-4c60-82d7-f262bd7d013d"
  }
}
...
resource "aws_instance" "ci-sockshop-k8s-master" {
  ...
  tags = {
    yor_trace = "ee45e85a-b360-4c9b-abd9-842b2602aac3"
  }
}
...
resource "aws_instance" "ci-sockshop-k8s-node" {
  ...
  tags = {
    yor_trace = "2e8ab699-8cfb-4b9c-a9bf-1e9d3520da52"
  }
}
...
resource "aws_elb" "ci-sockshop-k8s-elb" {
  ...
  tags = {
    yor_trace = "d08eb431-62bc-44c8-855d-e86d05365715"
  }
}
